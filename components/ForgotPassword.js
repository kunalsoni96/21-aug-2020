            ...
            <View style={styles.wrapper}>
                ...
                <View style={{ width: "100%" }}>
                    {this.state.Mobile.length === 10 ?
                        <Button style={styles.submitButton} onPress={this.submithandle}><Text style={{ color: "white", fontWeight: "bold" }}>Reset Password</Text></Button>
                ...
                <View style={{ marginBottom: 25, marginTop: 3, flexDirection: "row" }}>
                    <Text>Not registered?</Text><TouchableOpacity onPress={() => this.props.navigation.navigate('Register')}><Text style={{ color: "#080572" }}> Click Here</Text></TouchableOpacity>
                </View>
            </View>
        );
    }
